//Trabalho de Tecnicas e Programação 01
//Grupo: Geilson, Arthus, Taua, Richard, Michele e João Vitor.
/*Emails GitHub:
- richard.otto95@gmail.com
 -  ⁠arthusdias100@gmail.com
- joaocool92@gmail.com
- geilsondossantos098@gmail.com
-    ⁠michelelebarbenchon27@gmail.com
- tau.valentim@gmail.com
*/
 ...
 */
class Codigo{ // Tau Frade
private:
    const int TAMANHO = 6; /**< Tamanho fixo do código. */
 ...
 */
class Dinheiro{// Richard Otto

private:
    string valor; /**< Armazena o valor monetário. */
    const double LIMITE_MAX = 200000.00; /**< Limite máximo do valor. */
    const double LIMITE_MIN = 0;         /**< Limite mínimo do valor. */
 ...
 */
class Duracao{// Richard Otto
private:
    const int MINIMO = 0;   /**< Valor mínimo da duração. */
    const int MAXIMO = 360; /**< Valor máximo da duração. */
 ...
 */
class Horario{ //Geilson dos Santos
private:
 ...
 */
class Nome{ // Michele Nakagomi
private:
    const int VALOR_MAXIMO = 30; /**< Tamanho máximo do nome. */
 ...
 */
class Senha{ //Geilson dos Santos
